...
<body>
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="Main.html">Sign In</a>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="container" style=" padding: 200px">
        <form action="../Processes/Main.html" method="POST">
            <div class="form-group">
                <label for="exampleInputEmail1">Email address</label>
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?php if (isset($_GET['error'])) {
                                                                                                                                        echo $_GET['email'];
