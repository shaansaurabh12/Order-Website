<?php
session_start();
$conn = mysqli_connect("localhost","root","databases","foodies");
if(!$conn){  
...
<OPTION VALUE="Kandivali West" style="color:black;">Bareilly</OPTION>
<OPTION VALUE="Kandivali East" style="color:black;">Noida</OPTION>
<OPTION VALUE="Borivali East" style="color:black;">Gurugram</OPTION>
<OPTION VALUE="Borivali West" style="color:black;">Mumbai</OPTION>
</SELECT></TD>
</TR>
<TR class="left">
